...
# Default-Stop:      0 1 6
# Short-Description: Init script for dev.troisen.com node.js server
# Description:       Runs the production server for dev.troisen.com 
### END INIT INFO

# Author: My Name <duncan@suttree.com>
#
...
DAEMON_ARGS="/home/suttree/public_html/dev.troisen.com/current/server.js" # path to your node.js server/app

DESC="dev.troisen.com node.js server"         # whatever fancy description you like

NODEUSER=suttree:suttree                    # USER who OWNS the daemon process (no matter whoever runs the init script)
